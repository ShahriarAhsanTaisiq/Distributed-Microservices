...
* The original package name 'com.distributed-microservice.eureka-server' is invalid and this project uses 'com.distributed_microservice.eureka_server' instead.
